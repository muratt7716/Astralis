  ...
  return (
    <div className="cosmic-gradient">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-20 left-10 text-6xl float opacity-30 hidden md:block">🌙</div>
        <div className="absolute top-40 right-20 text-4xl float opacity-30 hidden md:block" style={{ animationDelay: "1s" }}>⭐</div>
        <div className="absolute bottom-20 left-1/4 text-5xl float opacity-20 hidden md:block" style={{ animationDelay: "2s" }}>✨</div>
        <div className="absolute bottom-40 right-10 text-3xl float opacity-25 hidden md:block" style={{ animationDelay: "0.5s" }}>🪐</div>

        <div className="text-center max-w-4xl mx-auto">
          {/* Zodiac Wheel */}
          <div className="relative w-48 h-48 mx-auto mb-8 spin-slow">
            <div className="absolute inset-0 rounded-full border-2 border-purple-500/30" />
            <div className="absolute inset-3 rounded-full border border-pink-500/20" />
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight font-serif tracking-tight text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/dogum-haritasi">
              <CosmicButton size="lg" variant="secondary" icon={<Logo size={20} />}>
                {t("hero.cta.chart")}
              </CosmicButton>
            </Link>
            <Link href="/yorumlar">
              <CosmicButton size="lg" variant="ghost" icon="✨">
                {t("hero.cta.daily")}
              </CosmicButton>
            </Link>
          </div>
      ...
      {/* Featured Section (Birth Chart CTA) */}
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center">
              <div className="text-center md:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                  <Link href="/dogum-haritasi">
                    <CosmicButton size="lg" icon={<Logo size={20} />}>
                      {t("home.featured.cta")}
                    </CosmicButton>
                  </Link>
                  <Link href="/hesaplayici">
      ...
      <section className="py-32 px-4 relative">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <Link href="/yorumlar">
            <CosmicButton size="lg" variant="primary" icon="🌟">
              {t("home.cta.btn")}
            </CosmicButton>
          </Link>
        </div>
